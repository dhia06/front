...
@Component({
  selector: 'app-lancer-app-doffres',
  templateUrl: './lancer-app-doffres.component.html',
  styleUrls: ['./lancer-app-doffres.component.scss']
})
export class  LancerAppDoffresComponent implements OnInit {
accr:any;
  id: string;
  kk:any;
